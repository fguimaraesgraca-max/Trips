...
const CITY_PROGRAMS: Record<string, Array<{ label: string; items: string[] }>> = {
  ...
  'Lençóis Maranhenses': [
    { label: 'Santo Amaro (base)', items: ['Circuito América — lagoas cristalinas pela manhã', 'Circuito Emendadas — 14h30 com caminhada 1h20 nas dunas', 'Mirar das Estrelas — experiência única à noite nas dunas'] },
    { label: 'Circuito Betânia', items: ['Passeio dia todo pelo Rio Preguiças', 'Lagoas emendadas + dunas gigantes', 'Termina em Barreirinhas — não voltar para Santo Amaro!'] },
    { label: 'Caburé + Quadriciclo', items: ['Caburé: única faixa de areia entre rio e mar aberto', 'Quadriciclo pelas dunas — óculos de sol e lenço indispensáveis', 'Pôr do sol entre o Rio Preguiças e o Oceano'] },
    { label: 'Boia Cross + Lagoa Bonita', items: ['Boia Cross: descida de boia nas corredeiras — levar roupa de banho!', 'Lagoa Bonita: pôr do sol mais famoso dos Lençóis (14h ao entardecer)', 'Protetor solar 50+ e câmera à prova d\'água'] },
  ],
  'Barreirinhas': [
    { label: 'Chegada (03/05)', items: ['Check-in após Circuito Betânia', 'Jantar na orla do Rio Preguiças', 'Confirmar horários dos passeios seguintes'] },
    { label: 'Dia 2 (04/05)', items: ['Combo Caburé + Quadriciclo — dia todo', 'Caburé: vila na foz entre mar e rio (único no Brasil!)', 'Quadriciclo nas dunas — levar óculos e lenço'] },
    { label: 'Dia 3 (05/05)', items: ['Boia Cross pela manhã — levar roupa de banho!', 'Descida de boia nas corredeiras do Rio Preguiças', 'Lagoa Bonita 14h — o pôr do sol mais famoso dos Lençóis'] },
    { label: 'Dia livre (06/05)', items: ['Orla do Rio Preguiças — sorvete de cupuaçu', 'Opcional: barco avulso para Mandacaru ou Atins', 'Artesanato local e relaxar antes da volta'] },
    { label: 'Saída (07/05)', items: ['Check-out — malas prontas antes das 11h', 'Transfer para SLZ às 11h30 (no pacote)', 'Voo SLZ → GRU às 18h45'] },
  ],
  'Atins': [
    { label: 'Day trip de Barreirinhas', items: ['Village pequeno e rústico — sem carros!', 'Kite e windsurf na lagoa (melhor vento do Brasil)', 'Jantar simples de pescador', 'Retorno de barco antes do anoitecer'] },
  ],
  'Santo Amaro': [
    { label: 'Chegada (29/04)', items: ['Transfer de SLZ às 13h — ~4h de viagem', 'Check-in na pousada ~17h', 'Jantar leve — sururu ou peixe fresco'] },
    { label: 'Dia 2 (30/04)', items: ['Manhã livre — explorar a vila colonial', 'Igreja de Santo Amaro e mercado local', 'Mirar das Estrelas privado: 19h às 22h — levar lanche!'] },
    { label: 'Dia 3 (01/05)', items: ['Circuito América — manhã', 'Lagoas cristalinas de água doce entre as dunas', 'Tarde livre — descanso antes do Emendadas'] },
    { label: 'Dia 4 (02/05)', items: ['Manhã livre — guardar energia para a tarde', 'Circuito Emendadas: 14h30 ao pôr do sol', '⚠️ Caminhada 1h20 nas dunas — calçado fechado!'] },
  ],
  'Bruges': [
